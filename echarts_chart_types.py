...
# flake8: noqa: E501
# Generated: 2026-04-01T23:19:16.658Z
...
ECHARTS_CHART_TYPES = {
    "line": {
        ...
        "configTemplate": {"type": "line", "series": [{"type": "line", "data": []}]},
    ...
    "bar": {
        ...
        "configTemplate": {"type": "bar", "series": [{"type": "bar", "data": []}]},
    ...
    "scatter": {
        ...
        "configTemplate": {"type": "scatter", "series": [{"type": "scatter", "data": []}]},
    ...
    "pie": {
        ...
        "configTemplate": {"type": "pie", "series": [{"type": "pie", "data": []}]},
    ...
    "radar": {
        ...
        "configTemplate": {"type": "radar", "series": [{"type": "radar", "data": []}]},
    ...
    "map": {
        ...
        "configTemplate": {"type": "map", "series": [{"type": "map", "data": []}]},
    ...
    "tree": {
        ...
        "configTemplate": {"type": "tree", "series": [{"type": "tree", "data": []}]},
        "goodFor": "Hierarchies",
        "examplesGalleryUrl": "https://echarts.apache.org/examples/",
    ...
    "treemap": {
        ...
        "configTemplate": {"type": "treemap", "series": [{"type": "treemap", "data": []}]},
    ...
    "graph": {
        ...
        "configTemplate": {"type": "graph", "series": [{"type": "graph", "data": []}]},
    ...
    "chord": {
        ...
        "configTemplate": {"type": "chord", "series": [{"type": "chord", "data": []}]},
    ...
    "gauge": {
        ...
        "configTemplate": {"type": "gauge", "series": [{"type": "gauge", "data": []}]},
        "goodFor": "KPI display",
        "examplesGalleryUrl": "https://echarts.apache.org/examples/",
    ...
    "funnel": {
        ...
        "configTemplate": {"type": "funnel", "series": [{"type": "funnel", "data": []}]},
    ...
    "parallel": {
        ...
        "configTemplate": {"type": "parallel", "series": [{"type": "parallel", "data": []}]},
    ...
    "sankey": {
        ...
        "configTemplate": {"type": "sankey", "series": [{"type": "sankey", "data": []}]},
    ...
    "boxplot": {
        ...
        "configTemplate": {"type": "boxplot", "series": [{"type": "boxplot", "data": []}]},
    ...
    "candlestick": {
        ...
        "configTemplate": {"type": "candlestick", "series": [{"type": "candlestick", "data": []}]},
    ...
    "effectScatter": {
        ...
        "configTemplate": {"type": "effectScatter", "series": [{"type": "effectScatter", "data": []}]},
    ...
    "lines": {
        ...
        "configTemplate": {"type": "lines", "series": [{"type": "lines", "data": []}]},
    ...
    "heatmap": {
        ...
        "configTemplate": {"type": "heatmap", "series": [{"type": "heatmap", "data": []}]},
    ...
    "pictorialBar": {
        ...
        "configTemplate": {"type": "pictorialBar", "series": [{"type": "pictorialBar", "data": []}]},
    ...
    "themeRiver": {
        ...
        "configTemplate": {"type": "themeRiver", "series": [{"type": "themeRiver", "data": []}]},
    ...
    "sunburst": {
        ...
        "configTemplate": {"type": "sunburst", "series": [{"type": "sunburst", "data": []}]},
    ...
    "custom": {
        ...
        "configTemplate": {"type": "custom", "series": [{"type": "custom", "data": []}]},
